...
export class InteractionError extends Error { constructor(readonly code: 'AUTH_REQUIRED' | 'FOOTPRINT_NOT_FOUND' | 'BLOCKED' | 'COMMENT_PARENT_INVALID' | 'COMMENT_DEPTH_INVALID' | 'COMMENT_FORBIDDEN' | 'REACTION_INVALID' | 'IDEMPOTENCY_CONFLICT') { super(code); this.name = 'InteractionError'; } }
