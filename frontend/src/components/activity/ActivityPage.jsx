...
export default function ActivityPage({ requireLogin, locationContext = {}, initialScope = 'smart', onReact }) {
  ...
  return (
    <main className="bliver-activity-page" aria-labelledby="activity-page-title">
      ...
      <ActivityScopeSheet open={sheetOpen} value={scope} onChange={setScope} onClose={() => setSheetOpen(false)} regionName={locationContext.regionName} countryName={locationContext.countryName} />
    </main>
  );
}
